...
public class CheckBoxDemo2A 
{
	...
	public static void main(String[] args) 
	{
	    ...
	    WebElement checkbox =	driver.findElement(By.xpath("//span[@id=\"content\"]/div[4]/div/form/table/tbody/tr[6]/td/label/span"));
		...
		checkbox .click();
		boolean actualcheckboxisselectedforafterclick=checkboxforselect.isSelected();
